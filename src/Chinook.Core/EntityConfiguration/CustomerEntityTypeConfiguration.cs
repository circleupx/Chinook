...
{
    class CustomerEntityTypeConfiguration : IEntityTypeConfiguration<CustomerServiceModel>
    {
        public void Configure(EntityTypeBuilder<CustomerServiceModel> entityTypeBuilder)
        {
