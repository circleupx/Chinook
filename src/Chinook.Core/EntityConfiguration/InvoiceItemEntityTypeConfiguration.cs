...
{
    class InvoiceItemEntityTypeConfiguration : IEntityTypeConfiguration<InvoiceItemServiceModel>
    {
        public void Configure(EntityTypeBuilder<InvoiceItemServiceModel> entityTypeBuilder)
        {
